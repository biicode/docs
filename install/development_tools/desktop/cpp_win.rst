...
* `MinGW, the minimalist GNU for Windows <http://www.mingw.org/>`_. **Optional**, you can use Visual Studio but we recommend using MinGW. This project provides an Open Source minimalist development environment for native Microsoft Windows applications. Follow `this link <http://sourceforge.net/projects/mingw/files/Installer/>`_ to get the installer, and choose while installing two additional packages, GCC and G++ package. 
