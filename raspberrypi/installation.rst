...
These steps are explained bellow:


1. Biicode initial setup
------------------------

First of all, **you need to complete the biicode software installation**. Read :ref:`the instructions in the general section of this documentation, following this link <first_steps>`. You must: 
