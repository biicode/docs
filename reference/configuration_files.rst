...
* Configuration files can also be placed inside the ``bii`` folder in a **hives** or **block**. These configurations provide **a finer control for specific projects and groups of files**, and override those settings contained in the workspace-level configuration.
