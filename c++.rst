...
Biicode will automatically analize your code, retrieve all missing dependencies and
...
In this context, biicode technology gives you several advantages to enrich your C++ experience:
   ...
   #. Reusing made easy: just ``#include`` the header file. No more copy and paste files from project to project or dowloading and compiling external libraries.
