...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7609.js" id="asciicast-7609" async data-speed="2" data-speed="2"></script>
...
Once you have completed all the coding process, and the source files are located under ``hello/blocks/your_user_name/hello_block``, you are ready to compile and run the application. Assuming that you are located in your biicode workspace folder, ``cd`` to your **"hello" hive folder**, and run the ``bii cpp:run`` command. This command needs to be executed from a folder containing a hive. After some messages showing information about the compiling process, the output message will appear in last place.

.. raw:: html

	<script type="text/javascript" src="https://asciinema.org/a/7610.js" id="asciicast-7610" async data-speed="2" data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7611.js" id="asciicast-7611" async data-speed="2" data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7612.js" id="asciicast-7612" async data-speed="2" data-speed="2"></script>


Add the following files to the folder ``hellopretty/blocks/your_user_name/hellopretty_block/`` (remember to substitute ``your_user_name`` with your actual biicode user name):
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7613.js" id="asciicast-7613" async data-speed="2" data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7614.js" id="asciicast-7614" async data-speed="2" data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7615.js" id="asciicast-7615" async data-speed="2" data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7616.js" id="asciicast-7616" async data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7617.js" id="asciicast-7617" async data-speed="2"></script>
...
.. raw:: html
	...
	<script type="text/javascript" src="https://asciinema.org/a/7618.js" id="asciicast-7618" async data-speed="2"></script>
